        ...
        <div className='p-4'>
            ...
            <div className='mb-6 '>
                ...
                {categories.map((category) => (
                    <div key={category} className='text-sm flex items-center mb-1'>
            ...
            <div className='mb-6 '>
                ...
                {genders.map((gender) => (
                    <div key={gender} className='text-sm flex items-center mb-1'>
                ...
                <div className="flex flex-wrap gap-2">
                    {colors.map((color) => (
                        <button
                            ...
                            className={`w-6 h-6 mt-2 rounded-full border border-gray-300 cursor-pointer transition hover:scale-105 ${filters.color === color ? "ring-2 ring-blue-500" : ""}`}
