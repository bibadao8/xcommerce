...
const Footer = () => {
    return <footer className='bg-[#d8cfbc] px-6 md:px-12 py-12'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 text-sm'>
            <div>
            ...
            <div>
                ...
                <p className='text-gray-700 mb-1'>Call Us</p>
